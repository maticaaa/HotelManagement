...
namespace Yixuan.Infrastructure.Migrations
{
    ...
    [Migration("20211117173627_TestForeignKey")]
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Service", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.Room", "TestRoom")
                        .WithMany("TestServices")
                        .HasForeignKey("TestRoomNo");
